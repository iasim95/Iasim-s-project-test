  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {link ? (
        ...
        <Button type="button" variant="outline" className="w-fit" onClick={handleInvite} disabled={pending}>
          {pending ? "Generando…" : "Invitar a mi pareja"}
        </Button>
      )}
      <p className="text-xs text-muted-foreground">
        El enlace caduca en 7 días. Quien lo abra podrá crear una cuenta y verá los mismos
